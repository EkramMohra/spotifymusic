...
router.get('/getLyrics/:artist/:songName', function(req, res) {
    let artist = req.params.artist;
    let songName = req.params.songName;
    request(`https://private-anon-380cab4478-lyricsovh.apiary-proxy.com/v1/${artist}/${songName}`, function(err, response, data) {
        res.send(JSON.parse(data));
    })
})

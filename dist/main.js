...
let client_id = 'b778df78861f4d05b2cd39e5578bfb99';
...
$('div').on('click', '#addToDB', function() {
    ...
    if (divName.parent().attr('class') === 'container') {
        ...
        if (!check) {
            setTimeout($.post("/saveSong", song, function(data) {
...
$('#dark').on('click', function() {
    ...
    if (c === off) {
        ...
        $('.song').css('box-shadow', 'rgb(133, 127, 127) 0px -6px 7px, 0px -2px 12px rgb(133, 127, 127), 0px 2px 3px rgb(133, 127, 127), 0px 2px 3px rgb(133, 127, 127)')
    }
})

$('div').on('click', '.myplaylist', function() {
